...
public class TeacherEditView extends ModelEditView<TeacherModel, TeacherPrototype> {

    public TeacherEditView(TeacherModel model, IStorage storage, IObjectManager<TeacherModel, TeacherPrototype> manager) {
